...
-   If you are using **Jupyter Lab**, you can launch a terminal from the Launcher window.
...
2.  Move into your **root directory**. If on a Unix-based system, you can do this by entering `cd` by itself. Note that MacOS is Unix-based.
