...
- Lutz, 2013, **[Learning Python](https://learning.oreilly.com/library/view/learning-python-5th/9781449355722/)**, 5th Edition, O'Reilly Media.
  - The [Sixth Edition](https://learning.oreilly.com/library/view/learning-python-6th/9781098171292/) of this text is now out. Textbook readings will be updated accordingly. If you have the patience and where possible, please refer to the new version. A lot has changed for Python between these two editions!
